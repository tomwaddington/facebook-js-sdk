try {
	window.FB || function(window) {
		...
		function __c() {
			...
			__d("PluginPipeConfig", [], {"threshold":0, "enabledApps":{0x65632ea70350:1, "cca6477272fc5cb805f85a84f20fca1d":1, 0xa2efa5f9730a:1}})
		}
		(function() {
			(function(a) {
				if(a.require) {
		...
		__d("ObservableMixin", [], function(a, b, c, d, e, f) {
			...
			g.prototype = {inform:function(h) {
				var i = Array.prototype.slice.call(arguments, 1), j = this.getSubscribers(h);
		...
		__d("sdk.Runtime", ["sdk.Model", "copyProperties", "sdk.RuntimeConfig"], function(a, b, c, d, e, f) {
			var g = b("sdk.Model"), h = b("copyProperties"), i = c("sdk.RuntimeConfig"), j = {UNKNOWN:0, PAGETAB:1, CANVAS:2, PLATFORM:4}, k = new g({AccessToken:"", UserID:0, ClientID:"", Initialized:false, LoginStatus:undefined, Environment:j.UNKNOWN, Secure:undefined, UseCookie:false, Locale:i.locale});
			h(k, {ENVIRONMENTS:j, isEnvironment:function(l) {
		...
		__d("FB", ["copyProperties", "dotAccess", "sdk.ErrorHandling", "sdk.getContextType", "GlobalCallback", "guid", "sdk.Insights", "Log", "sdk.Runtime", "safeEval", "sdk.Scribe", "wrapFunction", "SDKConfig"], function(a, b, c, d, e, f) {
			...
			o.setSecure(function() {
				if(location.protocol == "https:" && (window == top || !(aa || ba))) {
					return true
				}
		...
		__d("XDM", ["DOMEventListener", "DOMWrapper", "Flash", "Log", "UserAgent", "emptyFunction", "guid"], function(a, b, c, d, e, f) {
			var g = b("DOMEventListener"), h = b("DOMWrapper"), i = b("Flash"), j = b("Log"), k = b("UserAgent"), l = b("emptyFunction"), m = b("guid"), n = {}, o = {transports:[]}, p = h.getWindow();
			function q(s) {
			...
			r.register("flash", function() {
				...
				return{isAvailable:function() {
					...
					var aa = y.root.appendChild(p.document.createElement("div")), ba = m();
					u[ba] = function() {
						clearTimeout(x);
					...
					t = i.embed(y.flashUrl, aa, null, {protocol:location.protocol.replace(":", ""), host:location.host, callback:"FB_XDM_CALLBACKS." + ba, log:v});
		...
		__d("sdk.DOM", ["Assert", "createArrayFrom", "DOMEventListener", "sdk.domReady", "UserAgent"], function(a, b, c, d, e, f) {
			...
			function r(y, z, aa) {
				...
				if(z.querySelectorAll) {
					return h(z.querySelectorAll(aa + "." + y))
				}
				var ba = z.getElementsByTagName(aa), ca = [];
				for(var da = 0, ea = ba.length;da < ea;da++) {
					if(o(ba[da], y)) {
						ca[ca.length] = ba[da]
					}
				}
			...
			function s(y, z) {
				...
				var aa = y.currentStyle || document.defaultView.getComputedStyle(y, null), ba = aa[z];
				if(/backgroundPosition?/.test(z) && /top|left/.test(ba)) {
					ba = "0%"
				}
				return ba
			}
				...
				if(!k.ie()) {
					...
					try {
						...
						if(document.styleSheets[0]) {
							document.styleSheets[0].cssText += y
						}
					}
				}
			}
			function v() {
				...
				return{scrollTop:y.scrollTop || document.body.scrollTop, scrollLeft:y.scrollLeft || document.body.scrollLeft, width:window.innerWidth ? window.innerWidth : y.clientWidth, height:window.innerHeight ? window.innerHeight : y.clientHeight}
			}
			function w(y) {
				g.isTrue(!!y, "element not specified");
				var z = 0, aa = 0;
			...
			var x = {containsCss:o, addCss:p, removeCss:q, getByClass:r, getStyle:s, setStyle:t, getProp:m, html:n, addCssRules:u, getViewportInfo:v, getPosition:w, ready:j};
			e.exports = x
		});
		...
		__d("XFBML", ["Assert", "FB", "Log", "ObservableMixin", "copyProperties", "createArrayFrom", "dotAccess", "runOnce"], function(a, b, c, d, e, f) {
			...
			function v(y) {
				...
				if(!y.childNodes || y.childNodes.length === 0 || y.childNodes.length == 1 && y.childNodes[0].nodeType == 3 || y.getAttribute("fb-xfbml-state")) {
					return p[z[0]]
				}
			}
			function w(y) {
		...
		__d("PluginTags", [], function(a, b, c, d, e, f) {
			var g = {activity:{border_color:"string", filter:"string", action:"string", max_age:"string", linktarget:"string", header:"bool", recommendations:"bool", site:"hostname"}, create_event_button:{}, degrees:{href:"url"}, facepile:{href:"string", action:"string", size:"string", max_rows:"string"}, friendpile:{href:"string", action:"string", size:"string", max_rows:"string"}, page_events:{href:"url"}, privacy_selector:{}, recommendations:{border_color:"string", filter:"string", action:"string", 
			max_age:"string", linktarget:"string", header:"bool", site:"hostname"}, share_button:{href:"url", type:"string"}, shared_activity:{header:"bool"}, send_to_mobile:{max_rows:"string", show_faces:"bool", size:"string"}, subscribe:{href:"url", layout:"string", show_faces:"bool"}, want:{href:"url", layout:"string", show_faces:"bool"}};
			e.exports = g
		});
		...
		__d("PluginPipe", ["insertIframe", "FB", "XFBML", "copyProperties", "UrlMap", "guid", "ObservableMixin", "QueryString", "sdk.Runtime", "UserAgent", "SDKConfig", "PluginPipeConfig"], function(a, b, c, d, e, f) {
			var g = b("insertIframe"), h = b("FB"), i = b("XFBML"), j = b("copyProperties"), k = b("UrlMap"), l = b("guid"), m = b("ObservableMixin"), n = b("QueryString"), o = b("sdk.Runtime"), p = b("UserAgent"), q = c("SDKConfig"), r = c("PluginPipeConfig"), s = new m, t = r.threshold, u = [];
			function v() {
			...
			function x(y) {
				...
				var aa = {};
				ES5(y, "forEach", true, function(ba) {
					aa[ba.config.name] = {plugin:ba.tag, params:ba.params}
				});
				aa = {plugins:ES5("JSON", "stringify", false, aa)};
				ES5(y, "forEach", true, function(ba) {
					var ca = document.getElementsByName(ba.config.name)[0];
					ca.onload = ba.config.onload
				});
				g({url:k.resolve("www") + "/plugins/pipe/?" + n.encode(aa), root:z, name:l(), className:"fb_hidden fb_invisible"})
			}
			j(s, {add:function(y) {
				var z = v();
		...
		__d("IframePlugin", ["sdk.DOM", "sdk.Event", "ObservableMixin", "PluginTags", "QueryString", "sdk.Runtime", "Type", "UrlMap", "sdk.XD", "XFBML", "guid", "insertIframe", "resolveURI", "PluginPipe"], function(a, b, c, d, e, f) {
			var g = b("sdk.DOM"), h = b("sdk.Event"), i = b("ObservableMixin"), j = b("PluginTags"), k = b("QueryString"), l = b("sdk.Runtime"), m = b("Type"), n = b("UrlMap"), o = b("sdk.XD"), p = b("XFBML"), q = b("guid"), r = b("insertIframe"), s = b("resolveURI"), t = b("PluginPipe"), u = {skin:"string", font:"string", width:"px", height:"px", ref:"string", color_scheme:"string"};
			function v(ba, ca) {
				return function(da) {
			...
			var aa = m.extend({constructor:function(ba, ca, da, ea) {
				this.parent();
				da = da.replace(/-/g, "_");
				...
				var fa = n.resolve("www") + "/plugins/" + da + ".php?", ga = {};
				z(j[da], ba, ea, ga);
				z(u, ba, ea, ga);
				...
				this.subscribe("xd.verify", function(ka) {
					o.sendToFacebook(ia, {method:"xd/verify", params:ES5("JSON", "stringify", false, ka.token)})
				});
				...
				this._tag = da;
				this._params = ga;
				this._config = {root:ja, url:fa + k.encode(ga), name:ia, width:ga.width || 1E3, height:ga.height || 1E3, onload:ES5(this.inform, "bind", true, this, "render")}
			}, process:function() {
			...
			ES5(ES5("Object", "keys", false, j), "forEach", true, function(ba) {
				p.registerTag({xmlns:"fb", localName:ba.replace(/_/g, "-"), ctor:aa})
			});
			e.exports = aa
		});
		...
		__d("legacy:fb.init", ["sdk.Auth", "sdk.Canvas", "sdk.Canvas.Prefetcher", "sdk.Cookie", "copyProperties", "DOMWrapper", "sdk.domReady", "sdk.Event", "FB", "sdk.Frictionless", "Log", "sdk.Runtime", "sdk.SignedRequest", "UserAgent", "sdk.XD"], function(a, b, c, d) {
			...
			p.subscribe("AccessToken.change", function(u) {
				if(!u && p.getLoginStatus() === "connected") {
					m.getLoginStatus(null, true)
				}
			});
			...
			m.provide("", {initSitevars:{}, init:function(u) {
				if(p.getInitialized()) {
					o.warn("FB.init has already been called - this could indicate a problem")
				}
				...
				if(!u.logging && ES5(window.location.toString(), "indexOf", true, "fb_debug=1") < 0) {
					m._logging = false
				}
				var v = u.appId || u.apiKey;
				if(/number|string/.test(typeof v)) {
					p.setClientID(v.toString())
				}
				if("scope" in u) {
					m._scope = u.scope
				}
		...
		FB.provide("TemplateData", {_initialized:false, _version:0, _response:null, _localStorageTimeout:60 * 60 * 24, _enabled:true, enabled:function() {
			...
			if(b == "connected" && !FB.TemplateData.getResponse()) {
				FB.api({method:"dialog.template_data"}, function(c) {
					...
					var d = {data:c, currentUserID:FB.getUserID(), setAt:ES5("Date", "now", false), version:FB.TemplateData._version};
		...
		__d("legacy:fb.xfbml.commentscount", ["FB", "sdk.DOM", "sprintf"], function(a, b, c, d) {
			var e = b("FB"), f = b("sdk.DOM"), g = b("sprintf");
			e.subclass("XFBML.CommentsCount", "XFBML.Element", null, {process:function() {
				...
				e.Data._selectByIndex(["commentsbox_count"], "link_stat", "url", h).wait(ES5(function(i) {
					...
					if(j > 0) {
						f.removeCss(this.dom, "fb_comments_count_zero")
					}
					this.fire("render")
				}, "bind", true, this))
			}})
		...
		FB.provide("Anim", {ate:function(a, b, c, d) {
			...
			var e = 40, f = {}, g = {}, h = null, i = a.style, j = setInterval(ES5(function() {
				if(!h) {
					h = ES5("Date", "now", false)
				}
				var k = 1;
				if(c != 0) {
					k = Math.min((ES5("Date", "now", false) - h) / c, 1)
				}
