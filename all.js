	...
	(function() {
		...
		var ES5 = function() {
			...
			__d("JSON3", [], function(a, b, c, d, e, f) {
				var g = {}.toString, h = {}.hasOwnProperty, i, j, k;
					...
					if(j) {
						...
						try {
							switch(false) {
								...
								;
								case f.stringify({result:[m, true, false, null, "\x00\u0008\n\u000c\r\t"]}) == l:
								;
								case f.stringify(null, m) === "1":
								;
								case f.stringify([1, 2], null, 1) == "[\n 1,\n 2\n]":
								;
								case (m = new Date(-864E13)).getUTCFullYear() != -271821 || f.stringify(m) == '"-271821-04-20T00:00:00.000Z"':
								;
								case (m = new Date(864E13)).getUTCFullYear() != 275760 || f.stringify(m) == '"+275760-09-13T00:00:00.000Z"':
									j = false
							}
						}catch(p) {
							j = false
				...
				if(typeof h != "function") {
					h = function() {
						var l, m = {}, n = m.constructor;
						if((m.__proto__ = null, m.__proto__ = {toString:1}, m).toString != g) {
							l = function o(p) {
								var q = this.__proto__, r = p in (this.__proto__ = null, this);
								this.__proto__ = q;
								return r
							}
						}else {
				...
				i = function() {
					...
					if(!o) {
						...
						n = function q(r, s) {
							var t = g.call(r) == "[object Function]", u, v;
							for(u in r) {
								if(!(t && u == "prototype") && h.call(r, u)) {
									s(u)
								}
							}
							for(v = l.length;v--;) {
						...
						if(o == 2) {
							n = function q(r, s) {
								var t = {}, u = g.call(r) == "[object Function]", v;
								for(v in r) {
									if(!(u && v == "prototype") && !h.call(t, v) && (t[v] = 1) && h.call(r, v)) {
										s(v)
									}
								}
							}
							...
							n = function q(r, s) {
								var t = g.call(r) == "[object Function]", u, v;
								for(u in r) {
									if(!(t && u == "prototype") && h.call(r, u) && !(v = u === "constructor")) {
										s(u)
									}
								}
								if(v || h.call(r, "constructor")) {
									s("constructor")
								}
							}
						}
				...
				if(!j) {
					f.stringify = function() {
						...
						function n(q) {
							var r = '"', s = 0, t;
							for(;t = q.charAt(s);s += 1) {
								r += '\\"\u0008\u000c\n\r\t'.indexOf(t) > -1 ? l[t] : t < " " ? "\\u00" + m(2, t.charCodeAt(0).toString(16)) : t
							}
							return r + '"'
						}
						function o(q, r, s, t, u, v, w) {
							var x = r[q], y, z, aa, ba, ca, da, ea, fa;
							if(typeof x == "object" && x) {
								if(g.call(x) == "[object Date]" && !h.call(x, "toJSON")) {
									if(x > -1 / 0 && x < 1 / 0) {
										z = x.getUTCFullYear();
										x = (z <= 0 || z >= 1E4 ? (z < 0 ? "-" : "+") + m(6, z < 0 ? -z : z) : m(4, z)) + "-" + m(2, x.getUTCMonth() + 1) + "-" + m(2, x.getUTCDate()) + "T" + m(2, x.getUTCHours()) + ":" + m(2, x.getUTCMinutes()) + ":" + m(2, x.getUTCSeconds()) + "." + m(3, x.getUTCMilliseconds()) + "Z"
									}else {
										x = null
									}
								}else {
						...
						function p(q, r, s) {
							...
							if(typeof r == "function" || typeof r == "object" && r) {
								if(g.call(r) == "[object Function]") {
									...
									if(g.call(r) == "[object Array]") {
										...
										for(w = r.length;w--;) {
											x = r[w];
											if(x && (g.call(x) == "[object String]" || g.call(x) == "[object Number]")) {
												v[x] = 1
											}
										}
									}
							...
							if(s != null && s !== "") {
								if(g.call(s) == "[object Number]") {
									if((s -= s % 1) > 0) {
										for(t = "", s > 10 && (s = 10);t.length < s;) {
											t += " "
										}
									}
								}else {
									if(g.call(s) == "[object String]") {
										t = s.length <= 10 ? s : s.slice(0, 10)
									}
								}
							}
							return o("$", {$:q}, u, v, t, "", [])
				...
				if(!k) {
					f.parse = function() {
						var l = {"\\":"\\", '"':'"', "/":"/", b:"\u0008", t:"\t", n:"\n", f:"\u000c", r:"\r"}, m = "".constructor.fromCharCode;
						function n(s) {
							this.source = s;
							this.index = 0
						}
							...
							for(var s = this.source, t = this.source.length, u, v, w, x, y;this.index < t;) {
								...
								switch(u) {
									...
									default:
										...
										if(u >= "0" && u <= "9") {
											if(u == "0" && (u = s.charAt(this.index + 1), u >= "0" && u <= "9")) {
										...
										if(u == "t" && s.slice(this.index, this.index + 4) == "true") {
											...
											if(u == "f" && s.slice(this.index, this.index + 5) == "false") {
												this.index += 5;
												return false
											}else {
												if(u == "n" && s.slice(this.index, this.index + 4) == "null") {
													this.index += 4;
													return null
												}
											}
						...
						function r(s, t) {
							var u = new n("" + s), v = u.get(u.lex());
							if(u.lex() != "$") {
								throw SyntaxError("Expected end-of-file.");
							}
							return t && g.call(t) == "[object Function]" ? q({$:v}, "$", t) : v
						}
						return r
					}()
				}
		...
		(function(a) {
			...
			a[t] = w;
			a[s] = y;
			w.__debug = {modules:b, deps:c};
			var fa = false, ga = function(ha, ia, ja, ka) {
				x(ha, ia, ja, ka || g);
				if(b[ha][m] && !fa) {
		...
		if(window.FB && !window.FB.copy) {
			(function() {
				var a = /iframe_canvas|app_runner|dialog/.test(window.name);
				function b(c, d, e, f) {
					for(var g in d) {
						if(e || typeof c[g] === "undefined") {
							c[g] = f ? f(d[g]) : d[g]
						}
					}
					return c
				}
				b(window.FB, {_apiKey:null, _authResponse:null, _userStatus:"unknown", _logging:true, _inCanvas:a, _https:function() {
					if(location.protocol == "https:" && (window == top || !a)) {
						return true
					}
				...
				}, _domain:{api:"https://api.facebook.com/", api_read:"https://api-read.facebook.com/", cdn:"http://static.ak.fbcdn.net/", https_cdn:"https://s-static.ak.fbcdn.net/", graph:"https://graph.facebook.com/", staticfb:"http://static.ak.facebook.com/", https_staticfb:"https://s-static.ak.facebook.com/", www:"http://www.facebook.com/", https_www:"https://www.facebook.com/", m:"http://m.facebook.com/", https_m:"https://m.facebook.com/"}, _locale:null, _localeIsRtl:false, getDomain:function(c, d) {
				...
				}, copy:b, create:function(c, d) {
					var e = window.FB, f = c ? c.split(".") : [], g = f.length;
					for(var h = 0;h < g;h++) {
						var i = f[h], j = e[i];
						if(!j) {
							j = d && h + 1 == g ? d : {};
		...
		__d("copyProperties", [], function(a, b, c, d, e, f) {
			function g(h, i) {
				...
				if(i.hasOwnProperty && i.hasOwnProperty("toString") && typeof i.toString != "undefined" && h.toString !== i.toString) {
			...
			try {
				if(typeof FB.Flash._hasMinVersion === "undefined") {
					...
					majorVersion:for(c = 0, d = FB.Flash._minVersions.length;c < d;c++) {
						...
						for(var k = 1, l = j.length, m = e.length;k < l && k < m;k++) {
							if(e[k] < j[k]) {
								FB.Flash._hasMinVersion = false;
				...
				if(a.hasOwnProperty(c)) {
					...
					if(null === d || undefined === d) {
						...
						if(typeof d == "string") {
							...
							b[c] = ES5("JSON", "stringify", false, d)
						}
					}
				}
			}
		...
		FB.provide("ApiServer", {METHODS:["get", "post", "delete", "put"], _callbacks:{}, _readOnlyCalls:{fql_query:true, fql_multiquery:true, friends_get:true, notifications_get:true, stream_get:true, users_getinfo:true}, graph:function() {
			...
			var f = e;
			e = function(i) {
				if(FB.Auth && i && FB.getAccessToken() == d.access_token) {
					if(i.error == "invalid_token" || i.error_code == "190" || i.error && i.error.type == "OAuthException" && i.error.code == 190) {
			...
			try {
				if(FB.ApiServer.corsPost(a, b, c, d, e)) {
					return
				}
			}catch(h) {
			}
			...
			if(i) {
				if(e) {
					...
					i.onerror = function(j) {
						...
						if(!k || !k.error) {
							k = {error:"load-error: status " + j.status, raw:j.responseText}
						}
						e(k)
					}
				}
			...
			var f = FB.guid(), g = document.getElementsByTagName("script")[0], h = document.createElement("script");
			d = FB.copy({}, d);
			if(a === "graph" && c !== "get") {
				d.method = c
			}
			...
			h.onerror = function() {
				if(f in FB.ApiServer._callbacks) {
					FB.ApiServer._callbacks[f]({error:"load-error: unknown"})
				}
			};
			var j = function() {
				setTimeout(function() {
			...
			function i(k, l, m, n) {
				...
				p.onerror = function(q) {
					if(q.responseText) {
						...
						n({error:{type:"http", message:"unknown error", status:q.status}})
					}
				};
				p.send(o);
				return true
		...
		__d("Flash", ["QueryString", "UserAgent", "copyProperties", "guid"], function(a, b, c, d, e, f) {
			var g = b("QueryString"), h = b("UserAgent"), i = b("copyProperties"), j = b("guid"), k = {}, l;
			function m(r) {
			...
			var q = {embed:function(r, s, t, u) {
				var v = j();
				r = encodeURI(r);
				t = i({allowscriptaccess:"always", flashvars:u, movie:r}, t || {});
				if(typeof t.flashvars == "object") {
					t.flashvars = g.encode(t.flashvars)
				}
				var w = [];
				for(var x in t) {
					if(t.hasOwnProperty(x) && t[x]) {
						w.push('<param name="' + encodeURI(x) + '" value="' + encodeURI(t[x]) + '">')
					}
				}
				var y = document.createElement("div"), z = "<object " + (h.ie() ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' : 'type="application/x-shockwave-flash"') + 'data="' + r + '" ' + 'id="' + v + '">' + w.join("") + "</object>";
				y.innerHTML = z;
				var aa = s.appendChild(y.firstChild);
				p(v);
				return aa
			}, remove:m, getVersion:function() {
				var r = "Shockwave Flash", s = "application/x-shockwave-flash", t = "ShockwaveFlash.ShockwaveFlash", u;
				if(navigator.plugins && typeof navigator.plugins[r] == "object") {
					var v = navigator.plugins[r].description;
					if(v && navigator.mimeTypes && navigator.mimeTypes[s] && navigator.mimeTypes[s].enabledPlugin) {
						u = v.match(/\d+/g)
					}
				}
				if(!u) {
		...
		__d("GlobalCallback", ["dotAccess"], function(a, b, c, d, e, f) {
			var g = b("dotAccess"), h, i, j = 0, k = {setPrefix:function(l) {
				h = g(window, l, true);
				i = l
			}, create:function(l) {
				if(!h) {
		...
		__d("Log", ["sprintf"], function(a, b, c, d, e, f) {
			...
			function i(k, l) {
				...
				if(j.level >= k && window.console) {
					console[l in console ? l : "log"](n)
				}
			}
		...
		__d("URL", ["copyProperties", "QueryString", "Log"], function(a, b, c, d, e, f) {
			var g = b("copyProperties"), h = b("QueryString"), i = b("Log"), j = new RegExp("(" + "(((\\w+):)?//)" + "(.*?@)?" + "([^~/?#:]+)" + "(:(\\d+))?" + ")?" + "([^\\?$#]+)?" + "(\\?([^$#]+))?" + "(#([^$]+))?"), k = /[^\w\-\.,;\/\?:@=&%#$~+!*'\[\]()]/, l = /^[a-z0-9.][a-z0-9\-\.]+[a-z0-9.]$/, m = /\.facebook\.com$/;
			function n(o) {
				if(typeof o != "string") {
			...
			g(n.prototype, {constructor:n, getProtocol:function() {
		...
		__d("ApiClient", ["copyProperties", "flattenObject", "sprintf", "CORSRequest", "FlashRequest", "JSONPRequest", "Log", "UrlMap", "URL", "ApiClientConfig"], function(a, b, c, d, e, f) {
			var g = b("copyProperties"), h = b("flattenObject"), i = b("sprintf"), j = b("CORSRequest"), k = b("FlashRequest"), l = b("JSONPRequest"), m = b("Log"), n = b("UrlMap"), o = b("URL"), p = c("ApiClientConfig"), q, r, s, t, u = {get:true, post:true, "delete":true, put:true}, v = {fql_query:true, fql_multiquery:true, friends_get:true, notifications_get:true, stream_get:true, users_getinfo:true};
			function w(aa, ba, ca, da) {
				...
				var ea = {jsonp:l, cors:j, flash:k}, fa;
				if(ca.transport) {
					fa = [ca.transport];
					delete ca.transport
				}else {
				...
				var ga = function(ka) {
					if(r && ka && typeof ka == "object") {
						if("error" in ka || "error_code" in ka) {
							if(ka.error_code == "190" || ka.error == "invalid_token" || ka.error.type == "OAuthException" && ka.error.code == 190) {
								r()
							}
						}
					}
				...
				for(var ha = 0;ha < fa.length;ha++) {
					var ia = ea[fa[ha]], ja = g({}, ca);
					if(ia.execute(aa, ba, ja, ga)) {
						return
					}
				}
				da({error:{type:"no-transport", message:"Could not find a usable transport for request"}})
			}
			function x(aa) {
				if(typeof aa != "string") {
				...
				var ca = new o(aa), da = (ba.string || "get").toLowerCase(), ea = g(ba.object || {}, ca.getParsedSearch()), fa = ba["function"];
				if(!(da in u)) {
					throw new Error(i("Invalid method passed to ApiClient: %s", da));
				}
				ea.method = da;
			...
			function y(aa, ba) {
				...
				aa.api_key = s;
				var da = ca in v ? "api_read" : "api", ea = n.resolve(da) + "/restserver.php";
				w(ea, "get", aa, ba)
			}
			var z = {setAccessToken:function(aa, ba) {
				q = aa;
				r = ba
		...
		__d("legacy:fb.api", ["ApiClient", "FB", "GlobalCallback", "SDKConfig"], function(a, b, c, d) {
			var e = c("SDKConfig"), f = b("ApiClient"), g = b("FB"), h = b("GlobalCallback");
			f.setDefaultParams({sdk:"joey"});
			h.setPrefix("FB._callbacks");
			function i() {
				var j = g.getAccessToken(), k = function() {
					if(j == g.getAccessToken()) {
				...
				if(typeof arguments[0] === "string") {
					...
					f.rest.apply(f, arguments)
				}
			}
			if(e.migrate) {
				g.provide("", {api:i}, true)
			}
		}, 3);
		...
		__d("legacy:fb.arbiter", ["FB"], function(a, b, c, d) {
			var e = b("FB");
			e.provide("Arbiter", {BEHAVIOR_EVENT:"e", BEHAVIOR_PERSISTENT:"p", BEHAVIOR_STATE:"s", inform:function(f, g, h, i, j) {
				e.XD.sendToFacebook("facebook", {method:f, params:ES5("JSON", "stringify", false, g || {}), behavior:j || e.Arbiter.BEHAVIOR_PERSISTENT, relation:h})
			}})
		}, 3);
		...
		__d("XDM", ["Flash", "DOMEventListener", "Log", "guid", "copyProperties"], function(a, b, c, d, e, f) {
			var g = b("Flash"), h = b("DOMEventListener"), i = b("Log"), j = b("guid"), k = b("copyProperties"), l = {}, m = {transports:[]};
			function n(p) {
				var q = {}, r = p.length, s = m.transports;
				while(r--) {
					q[p[r]] = 1
				}
				r = s.length;
				while(r--) {
					var t = s[r], u = l[t];
					if(!q[t] && u.isAvailable()) {
						return t
					}
				}
			}
			var o = {register:function(p, q) {
				...
				if(!p.whenReady) {
					p.whenReady = bagofholding
				}
				if(!p.onMessage) {
					p.onMessage = bagofholding
				}
				var q = p.transport || n(p.blacklist || []), r = l[q];
				if(r && r.isAvailable()) {
			...
			o.register("fragment", function() {
				var p = false, q, r = location.protocol + "//" + location.host;
				function s(t) {
			...
			o.register("flash", function() {
				var p = false, q, r = {}, s = false;
				return{isAvailable:function() {
					return g.isAvailable()
				}, init:function(t) {
					i.debug("init flash: " + t.channel);
					var u = {send:function(x, y, z, aa) {
					...
					var v = t.root.appendChild(document.createElement("div")), w = j();
					r[w] = function() {
					...
					q = g.embed(t.flashUrl, v, null, {protocol:location.protocol.replace(":", ""), host:location.host, callback:"FB_XDM_CALLBACKS." + w, log:s});
					p = true
				}}
			}());
			o.register("postmessage", function() {
				...
				return{isAvailable:function() {
					...
					var r = "_FB_" + q.channel, s = {send:function(t, u, v, w) {
						if(window === v) {
					...
					h.add(window, "message", function(event) {
						var t = event.data, u = event.origin || "native";
						if(typeof t != "string") {
		...
		__d("SDK_XD", ["XDM", "Log", "QueryString", "Queue", "resolveWindow", "guid", "XDConfig"], function(a, b, c, d, e, f) {
			var g = c("XDConfig"), h = b("XDM"), i = b("Log"), j = b("QueryString"), k = b("Queue"), l = b("resolveWindow"), m = b("guid"), n = new k, o = new k, p = new k, q, r, s = m(), t = m(), u = location.protocol + "//" + location.host, v, w = false, x = {};
			function y(ea) {
				i.info("Remote XD can talk to facebook.com (%s)", ea);
				if(ea == "canvas") {
					FB._inCanvas = true
				}else {
					FB.Canvas._isTabIframe = true
				}
			}
			function z(ea, fa) {
				if(!fa) {
			...
			function aa(ea, fa) {
				...
				if(ea.access_token) {
					FB._https = /^https/.test(u)
				}
				if(ea.cb) {
					var ha = FB.XD._callbacks[ea.cb];
					if(!FB.XD._forever[ea.cb]) {
						delete FB.XD._callbacks[ea.cb]
					}
					if(ha) {
						ha(ea)
					}
			...
			var da = {_callbacks:{}, _forever:{}, _channel:t, _origin:u, onMessage:aa, recv:aa, init:function(ea) {
				if(w) {
					return
				}
				var fa = ea ? /\/\/.*?(\/[^#]*)/.exec(ea)[1] : location.pathname + location.search;
				fa += (~ES5(fa, "indexOf", true, "?") ? "&" : "?") + "fb_xd_fragment#xd_sig=" + s + "&";
				var ga = FB.Content.appendHidden(document.createElement("div")), ha = h.create({root:ga, channel:t, channelPath:"/" + g.XdUrl + "#", flashUrl:g.Flash.path, whenReady:function(ma) {
					v = ma
				}, onMessage:aa}), ia = {channel:t, origin:location.protocol + "//" + location.host, channel_path:fa, transport:ha}, ja = g.XdUrl + "#" + j.encode(ia), ka = g.useCdn ? FB._domain.staticfb : "http://www.facebook.com/", la = g.useCdn ? FB._domain.https_staticfb : "https://www.facebook.com/";
				if(!FB.onlyUseHttps()) {
					q = ca({url:ka + ja, name:"fb_xdm_frame_http", root:ga})
				}
				r = ca({url:la + ja, name:"fb_xdm_frame_https", root:ga});
				w = true
				...
				ha = ha || m();
				if(ga) {
					FB.XD._forever[ha] = true
				}
				FB.XD._callbacks[ha] = ea;
				var ia = location.protocol == "https:" ? FB._domain.https_staticfb : FB._domain.staticfb, ja = g.useCdn ? ia : location.protocol + "//www.facebook.com/";
				return ja + g.XdUrl + "#" + j.encode({cb:ha, origin:u + "/" + t, domain:location.hostname, relation:fa || "opener"})
			}};
			(function() {
				var ea = location.href.match(/[?&]fb_xd_fragment#(.*)$/);
				if(ea) {
					document.documentElement.style.display = "none";
					var fa = j.decode(ea[1]), ga = l(fa.xd_rel);
		...
		__d("legacy:fb.xd", ["FB", "SDK_XD"], function(a, b, c, d) {
			var e = b("FB"), f = b("SDK_XD");
			e.provide("XD", f)
		}, 3);
		FB.provide("Canvas", {_timer:null, _lastSize:{}, _isTabIframe:!!~ES5(window.name, "indexOf", true, "app_runner_"), _pageInfo:{clientWidth:0, clientHeight:0, scrollLeft:0, scrollTop:0, offsetLeft:0, offsetTop:0}, getPageInfo:function(a) {
			...
			for(var c = 0;c < b.length;c++) {
				...
				for(var f = 0;f < d.childNodes.length;f++) {
					if(d.childNodes[f].nodeName.toLowerCase() == "param" && d.childNodes[f].name.toLowerCase() == "wmode") {
						if(d.childNodes[f].value.toLowerCase() == "opaque" || d.childNodes[f].value.toLowerCase() == "transparent") {
							e = true
						}
					}
				}
				if(!e) {
					...
					if(FB.Canvas._devHideFlashCallback) {
						var h = 200, i = {state:a.state, elem:d}, j = ES5(function(k) {
							if(k.state == "opened") {
			...
			if(!FB._initialized && arguments.callee.caller != FB.setAutoGrow) {
				FB.log("FB.init is required for setSize to take effect")
			}
			if(typeof a != "object") {
				a = {}
			}
			...
			if(FB.Canvas._lastSize[a.frame]) {
				...
				if(FB.Canvas._lastSize[a.frame].width == a.width && e <= c && e >= -b) {
					return false
				}
			}
			...
			if(!FB._initialized) {
				FB.log("FB.init is required for scrollTo to take effect")
			}
			FB.Arbiter.inform("scrollTo", {frame:window.name || "iframe_canvas", x:a, y:b})
		}, setAutoGrow:function(a, b) {
			if(!FB._initialized) {
				FB.log("FB.init is required for setAutoGrow to take effect")
			}
			...
			if(a === undefined || a) {
				if(FB.Canvas._timer === null) {
					FB.Canvas._timer = window.setInterval(FB.Canvas.setSize, b || 100)
				}
				FB.Canvas.setSize()
			}else {
				if(FB.Canvas._timer !== null) {
			...
			if(!FB._initialized) {
				FB.log("FB.init is required for setUrlHandler to take effect")
			}
			...
			var c = null;
			if(a) {
				c = FB.XD.handler(a, "top.frames[" + window.name + "]", false)
			}
			...
			if(a.offsetWidth < a.scrollWidth) {
				...
				ES5(FB.Array.toArray(a.childNodes), "forEach", true, function(j) {
		...
		FB.provide("Dom", {containsCss:function(a, b) {
			...
			if(b.querySelectorAll) {
				return FB.Array.toArray(b.querySelectorAll(c + "." + a))
			}
			...
			if(a.currentStyle) {
				...
				if(window.getComputedStyle) {
					...
					if(b == "background-position-y" || b == "background-position-x") {
						if(c == "top" || c == "left") {
							c = "0px"
						}
					}
		...
		FB.provide("Dialog", {_dialogs:null, _lastYOffset:0, _loaderEl:null, _overlayEl:null, _stack:[], _active:null, get:function(a) {
			...
			var a = FB.UA.nativeApp() ? "" : "<table>" + "	<tbody>" + "		<tr>" + '			<td class="header_left">' + '				<label class="touchable_button">' + '					<input type="submit" value="' + FB.Intl.tx._("Cancel") + '"' + '						id="fb_dialog_loader_close"/>' + "				</label>" + "			</td>" + '			<td class="header_center">' + "				<div>" + FB.Intl.tx._("Loading...") + "</div>" + "			</td>" + '			<td class="header_right">' + "			</td>" + "		</tr>" + "	</tbody>" + 
			"</table>";
			...
			if(!FB.Dialog._loaderEl) {
				FB.Dialog._loaderEl = FB.Dialog._findRoot(FB.UA.mobile() ? FB.Dialog._createMobileLoader() : FB.Dialog._createWWWLoader(b))
			}
			if(!a) {
				a = function() {
				}
			...
			if(a) {
				i = a.scrollTop - a.offsetTop + (a.clientHeight - e) / 2
			}
			if(i < g) {
				i = g
			}else {
			...
			if(FB.UA.ipad()) {
				...
				for(var b in FB.Dialog._dialogs) {
					if(document.getElementById(b)) {
						document.getElementById(b).style.width = FB.UIServer.getDefaultSize().width + "px"
					}
				}
			}
			...
			if(FB.UA.ie()) {
				...
				d += FB.UA.mobile() ? " fb_dialog_mobile" : " fb_dialog_advanced"
			}
			if(a.content) {
			...
			if(a) {
				...
				if(b) {
					...
					if(FB.Dialog._active === null && FB.Dialog._stack.length > 0) {
						FB.Dialog.show(FB.Dialog._stack.pop())
					}
				}
				window.setTimeout(function() {
		...
		FB.provide("UIServer", {Methods:{}, _loadedNodes:{}, _defaultCb:{}, _resultToken:'"xxRESULTTOKENxx"', _forceHTTPS:false, genericTransform:function(a) {
			...
			if(!(g.id in FB.UIServer._defaultCb) && !("next" in g.params) && !("redirect_uri" in g.params)) {
			...
			if(b === "dialog" || b === "iframe" || b === "hidden" || b === "none") {
				return"parent"
			}
			if(b === "async") {
			...
			k.push("top=" + j);
			k.push("scrollbars=1");
			if(a.name == "permissions.request" || a.name == "permissions.oauth") {
			...
			if(a.params && a.params.in_iframe) {
				...
				if(FB.UA.nativeApp() && !a.ui_created) {
					a.frame = a.id;
			...
			if(a.post) {
				...
				FB.Content.insertIframe({url:a.url, root:a.root, className:a.className, width:a.size.width, height:a.size.height, id:a.id, name:a.frameName, onInsert:b})
			}
			...
			for(var b in FB.UIServer._loadedNodes) {
				if(FB.UIServer._loadedNodes.hasOwnProperty(b) && b in FB.UIServer._defaultCb) {
					var c = FB.UIServer._loadedNodes[b];
					if(c.type != "popup" && c.type != "native") {
						continue
					}
					win = c.node;
					try {
			...
			if(c) {
				try {
					if(FB.Dom.containsCss(c, "FB_UI_Hidden")) {
						...
						if(FB.Dom.containsCss(c, "FB_UI_Dialog")) {
							FB.Dialog.remove(c);
		...
		FB.provide("Auth", {_callbacks:[], _xdStorePath:"xd_localstorage/", login:function(a, b) {
			...
			if(FB.UA.mobile() && window.postMessage && window.localStorage) {
				...
				FB.ui({method:"login.status", display:"none", domain:location.hostname}, a)
			}
			...
			return function(d) {
				if(d.access_token) {
					...
					if(FB.Cookie.getEnabled()) {
						var f = b.expiresIn === 0 ? 0 : (new Date).getTime() + b.expiresIn * 1E3, g = FB.Cookie._domain;
						if(!g && d.base_domain) {
							g = "." + d.base_domain
						}
					...
					if(!FB._authResponse && b) {
						FB.Auth.setAuthResponse(b, "connected")
					}else {
						if(c === "logout" || c === "login_status") {
							var h;
		...
		__d("Upsell", ["URL"], function(a, b, c, d, e, f) {
			var g = b("URL"), h = false, i = {init:function(j) {
				if(h) {
					return
				}
				h = true;
				...
				if(k && k.isFacebookURL() && l.getParsedSearch().fb_upsell) {
					j.getLoginStatus(function(o) {
						if(o.status == "not_authorized") {
							j.ui({display:"iframe", method:"permissions.oauth", auth_referral:true})
						}
					})
				}
			}};
		...
		FB.provide("Canvas.Prefetcher", {_sampleRate:0, _appIdsBlacklist:[], _links:[], COLLECT_AUTOMATIC:0, COLLECT_MANUAL:1, _collectionMode:0, addStaticResource:function(a) {
			...
			if(a != FB.Canvas.Prefetcher.COLLECT_AUTOMATIC && a != FB.Canvas.Prefetcher.COLLECT_MANUAL) {
				return false
			}
			...
			if(ES5(FB.Canvas.Prefetcher._appIdsBlacklist, "indexOf", true, parseInt(FB._apiKey, 10)) != -1) {
				return
			}
			...
			if(FB.Canvas.Prefetcher._collectionMode == FB.Canvas.Prefetcher.COLLECT_AUTOMATIC) {
				ES5(FB.Array, "forEach", true, a, function(c, d) {
		...
		FB.provide("", {initSitevars:{}, init:function(a) {
			...
			FB._userID = 0;
			if(!a.logging && ES5(window.location.toString(), "indexOf", true, "fb_debug=1") < 0) {
				FB._logging = false
			}
		...
		FB.provide("XFBML", {_renderTimeout:3E4, getElements:function(a, b, c) {
			...
			ES5(FB.XFBML._tagInfos, "forEach", true, function(f) {
				...
				if(e[f.localName] !== undefined) {
					...
					g = FB.XFBML.getElements(a, f.xmlns, f.localName)
				}
			...
			window.setTimeout(function() {
				if(c > 0) {
					FB.log(c + " XFBML tags failed to render in " + FB.XFBML._renderTimeout + "ms.")
				}
				...
				if(FB.UA.ie() < 9) {
					try {
						...
						if(f && f[b]) {
							...
							if(!document.addEventListener || g.length > 0) {
								return g
							}
						}
					}catch(e) {
			...
			switch(this.where.type) {
				...
				case "in":
					if(this.where.value.length == 1) {
						...
						a += this.where.key + " in (" + ES5(this.where.value, "map", true, this._encode).join(",") + ")"
					}
					break
			}
			return a
		...
		FB.provide("Data", {query:function(a, b) {
			...
			FB.api("/fql", "GET", e, function(f) {
				if(f.error) {
					...
					ES5(f.data, "forEach", true, function(g) {
		...
		FB.provide("TemplateData", {_initialized:false, _version:0, _response:null, _localStorageTimeout:60 * 60 * 24, _enabled:true, enabled:function() {
			...
			if(!a || !a.version || a.version != FB.TemplateData._version || a.currentUserID != FB.getUserID()) {
				return true
			}
			var b = Math.round((new Date).getTime());
			return(b - a.setAt) / 1E3 > FB.TemplateData._localStorageTimeout
			...
			if(FB.TemplateData.supportsLocalStorage()) {
				localStorage.FB_templateDataResponse = ES5("JSON", "stringify", false, a)
			}
		}, getData:function() {
			...
			if(FB._userStatus == "connected" && !FB.TemplateData.getResponse()) {
				FB.api({method:"dialog.template_data"}, function(b) {
					if("error_code" in b) {
						return
					}
		...
		FB.subclass("TemplateUI", "Obj", function(a, b) {
			...
			if(c) {
				...
				if(b && !FB.TemplateUI._preloads[this.cachedCall.url]) {
		...
		FB.subclass("XFBML.IframeWidget", "XFBML.Element", null, {_iframeName:null, _showLoader:true, _refreshOnAuthChange:false, _allowReProcess:false, _fetchPreCachedLoader:false, _visibleAfter:"load", _widgetPipeEnabled:false, getUrlBits:function() {
			...
			FB.Content.insertIframe({url:c, root:this.dom.appendChild(document.createElement("span")), name:this.getIframeName(), title:this.getIframeTitle(), className:FB._localeIsRtl ? "fb_rtl" : "fb_ltr", height:b.height, width:b.width, onload:ES5(this.fire, "bind", true, this, "iframe.onload")});
			this._resizeFlow(b);
			this.loaded = false;
		...
		FB.subclass("XFBML.ButtonElement", "XFBML.Element", null, {_allowedSizes:["icon", "small", "medium", "large", "xlarge"], onClick:function() {
			...
			if(!("_originalHTML" in this)) {
				this._originalHTML = ES5(this.dom.innerHTML, "trim", true)
			}
			if(!this.setupAndValidate()) {
				this.fire("render");
				return
		...
		FB.subclass("XFBML.Facepile", "XFBML.IframeWidget", null, {_visibleAfter:"load", _extraParams:{}, setupAndValidate:function() {
			...
			this.clear();
			for(var b in this._extraParams) {
				this._attr[b] = this._extraParams[b]
			}
			return true
		...
		FB.subclass("XFBML.Comments", "XFBML.IframeWidget", null, {_visibleAfter:"immediate", _refreshOnAuthChange:true, setupAndValidate:function() {
			...
			if(!a.href) {
				...
				if(a.migrated) {
					a.href = "http://www.facebook.com/plugins/comments_v1.php?" + "app_id=" + FB._apiKey + "&xid=" + encodeURIComponent(a.xid) + "&url=" + encodeURIComponent(a.url)
				}
			}else {
				var c = this.getAttribute("fb_comment_id");
				if(!c) {
					c = FB.QS.decode(document.URL.substring(ES5(document.URL, "indexOf", true, "?") + 1)).fb_comment_id;
					if(c && ES5(c, "indexOf", true, "#") > 0) {
						c = c.substring(0, ES5(c, "indexOf", true, "#"))
					}
				}
				if(c) {
					a.fb_comment_id = c;
					...
					ES5(FB.Array, "forEach", true, f[m], function(p, q) {
						if(isNaN(g[m][q].numPart) && g[m][q].textPart == "?") {
							...
							if(isNaN(p.numPart)) {
								...
								o += p.numPart + Math.ceil((g[m][q].numPart - p.numPart) * Math.sin(Math.PI / 2 * k)) + g[m][q].textPart + " "
							}
						}
					});
		...
		FB.subclass("XFBML.ConnectBar", "XFBML.Element", null, {_initialHeight:null, _initTopMargin:0, _picFieldName:"pic_square", _page:null, _displayed:false, _notDisplayed:false, _container:null, _animationSpeed:0, process:function() {
			...
			b.innerHTML = FB.String.format('<div class="fb_buttons">' + '<a href="#" class="fb_bar_close">' + '<img src="{1}" alt="{2}" title="{2}"/>' + "</a>" + "</div>" + '<a href="{7}" class="fb_profile" target="_blank">' + '<img src="{3}" alt="{4}" title="{4}"/>' + "</a>" + "{5}" + " <span>" + '<a href="{8}" class="fb_learn_more" target="_blank">{6}</a> &ndash; ' + '<a href="#" class="fb_no_thanks">{0}</a>' + "</span>", FB.Intl.tx._("No Thanks"), FB.getDomain("cdn") + FB.XFBML.ConnectBar.imgs.buttonUrl, 
			FB.Intl.tx._("Close"), a[this._picFieldName] || FB.getDomain("cdn") + FB.XFBML.ConnectBar.imgs.missingProfileUrl, FB.String.escapeHTML(a.first_name), FB.Intl.tx._("Hi {firstName}. <strong>{siteName}</strong> is using Facebook to personalize your experience.", {firstName:FB.String.escapeHTML(a.first_name), siteName:FB.String.escapeHTML(a.site_name)}), FB.Intl.tx._("Learn More"), a.profile_url, FB.getDomain("www") + "sitetour/connect.php");
			var d = this;
			...
			if(this._page.parentNode) {
				...
				e = parseInt(FB.Dom.getStyle(this._page, "marginTop"), 10)
			}
			e = isNaN(e) ? 0 : e;
			...
			if(FB.UA.ie()) {
				...
				f.backgroundPosition = "? " + this._initialHeight + "px"
			}
		...
		FB.provide("XFBML.EdgeCommentWidget", {NextZIndex:1E4});
		FB.subclass("XFBML.EdgeWidget", "XFBML.IframeWidget", null, {_visibleAfter:"immediate", _showLoader:false, _rootPadding:null, setupAndValidate:function() {
			...
			j), l = {standard:{min:e, max:900}, box_count:{min:g, max:900}, button_count:{min:f, max:900}, simple:{min:49, max:900}};
			if(k < l[a].min) {
				k = l[a].min
			}else {
				if(k > l[a].max) {
		...
		FB.subclass("XFBML.LoginButton", "XFBML.ButtonElement", null, {setupAndValidate:function() {
			...
			if(this._attr.autologoutlink) {
				FB.Event.subscribe("auth.statusChange", ES5(this.process, "bind", true, this))
			}
			...
			if(!this._attr.registration_url) {
				if(!FB.getAccessToken() || !this._attr.autologoutlink) {
					FB.login(ES5(this._authCallback, "bind", true, this), {perms:this._attr.perms, scope:this._attr.scope})
				}else {
					FB.logout(ES5(this._authCallback, "bind", true, this))
				}
			}else {
				switch(this._attr.status) {
					case "unknown":
						FB.ui({method:"auth.logintoFacebook"}, ES5(function(a) {
			...
			return ES5(function(c) {
				if(b && this._attr.registration_url && (this._attr.status == "notConnected" || this._attr.status == "not_authorized") && (c.status == "notConnected" || c.status == "not_authorized")) {
					window.top.location = this._attr.registration_url
				}
		...
		FB.subclass("XFBML.Name", "XFBML.Element", null, {process:function() {
			...
			FB.Event.monitor("auth.statusChange", ES5(this, "bind", true, function() {
				...
				if(FB.Helper.isUser(this._uid)) {
					...
					b = FB.Data._selectByIndex(["name", "id"], "profile", "id", this._uid)
				}
			...
			if(this._uid == FB.Helper.getLoggedInUser() && this._getBoolAttribute("use-you", true)) {
				...
				if(a) {
					...
					if(this._firstnameonly && a.first_name !== undefined) {
						...
						if(this._lastnameonly && a.last_name !== undefined) {
		...
		FB.subclass("XFBML.PrivacySelector", "XFBML.IframeWidget", null, {getUrlBits:function() {
			...
			this._attr = {channel:this.getChannelUrl(), api_key:FB._apiKey, font:this.getAttribute("font")};
			this._showLoader = false;
			return true
		}, getSize:function() {
			return{width:99, height:22}
		}});
		FB.subclass("XFBML.ProfilePic", "XFBML.Element", null, {process:function() {
			...
			var g = ES5(this, "bind", true, function(h) {
				...
				if(!j) {
					j = FB.getDomain("cdn") + FB.XFBML.ProfilePic._defPicMap[b]
				}
				...
				if(this._getBoolAttribute("linked", true)) {
					l = FB.Helper.getProfileLink(i, l, this.getAttribute("href", null))
				}
		...
		FB.subclass("XFBML.RecommendationsBar", "XFBML.IframeWidget", null, {getUrlBits:function() {
			...
			var e = ES5(function() {
				...
				window.setTimeout(ES5(this.arbiterInform, "bind", true, this, "platform/plugins/recommendations_bar/action", null, FB.Arbiter.BEHAVIOR_STATE), this._attr.read_time * 1E3);
				return true
			}, "bind", true, this);
		...
		FB.subclass("XFBML.Registration", "XFBML.IframeWidget", null, {_visibleAfter:"immediate", _baseHeight:167, _fieldHeight:28, _skinnyWidth:520, _skinnyBaseHeight:173, _skinnyFieldHeight:52, setupAndValidate:function() {
			...
			if(this._attr.onvalidate) {
				this.subscribe("xd.validate", ES5(this, "bind", true, function(a) {
...
FB.provide("Flash", {"_minVersions":[[10, 3, 181, 34], [11, 0, 0]], "_swfPath":"rsrc.php/v1/ym/r/WT2HOUZkT6k.swf"}, true);
...
"export_stream":false, "publish_stream":true, "publish_likes":true, "ads_management":false, "contact_email":true, "access_private_data":false, "read_insights":false, "read_requests":false, "read_friendlists":true, "manage_pages":false, "physical_login":false, "manage_groups":false, "read_deals":false}};
FB.forceOAuth = true;
