...
FB.provide("Canvas", {_timer:null, _lastSize:{}, _pageInfo:{clientWidth:0, clientHeight:0, scrollLeft:0, scrollTop:0, offsetLeft:0, offsetTop:0}, getPageInfo:function(a) {
	...
	for(var d = 0;d < a.length;d++) {
		var b = a[d];
		if(b.type != "application/x-shockwave-flash") {
			continue
		}
		var c = false;
		for(var e = 0;e < b.childNodes.length;e++) {
			if(b.childNodes[e].nodeName == "PARAM" && b.childNodes[e].name == "wmode") {
				if(b.childNodes[e].value != "window" && b.childNodes[e].value != "default") {
					c = true
				}
			}
		}
	...
	if(a) {
		FB.Canvas._hideFlashCallback = a
	}
}, init:function() {
