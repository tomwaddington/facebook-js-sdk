window.FB || function() {
		...
		__d("JSON3", [], function(a, b, c, d, e, f) {
			(function() {
				...
				if(m = typeof k.stringify == "function" && !ea) {
					...
					try {
						m = k.stringify(0) === "0" && k.stringify(new Number) === "0" && k.stringify(new String) == '""' && k.stringify(g) === j && k.stringify(j) === j && k.stringify() === j && k.stringify(ba) === "1" && k.stringify([ba]) == "[1]" && k.stringify([j]) == "[null]" && k.stringify(null) == "null" && k.stringify([j, g, null]) == "[null,null,null]" && k.stringify({result:[ba, true, false, null, "\x00\b\n\f\r\t"]}) == l && k.stringify(null, ba) === "1" && k.stringify([1, 2], null, 1) == "[\n 1,\n 2\n]" && 
						k.stringify(new Date(-864E13)) == '"-271821-04-20T00:00:00.000Z"' && k.stringify(new Date(864E13)) == '"+275760-09-13T00:00:00.000Z"' && k.stringify(new Date(-621987552E5)) == '"-000001-01-01T00:00:00.000Z"' && k.stringify(new Date(-1)) == '"1969-12-31T23:59:59.999Z"'
					}catch(fa) {
						m = false
					}
				}
							...
							if(typeof na == "object" && na) {
								...
								if(oa == "[object Date]" && !h.call(na, "toJSON")) {
									if(na > -1 / 0 && na < 1 / 0) {
										...
										na = (pa <= 0 || pa >= 1E4 ? (pa < 0 ? "-" : "+") + o(6, pa < 0 ? -pa : pa) : o(4, pa)) + "-" + o(2, qa + 1) + "-" + o(2, ra) + "T" + o(2, ta) + ":" + o(2, ua) + ":" + o(2, va) + "." + o(3, wa) + "Z"
									}else {
										na = null
									}
								}else {
									if(typeof na.toJSON == "function" && (oa != "[object Number]" && oa != "[object String]" && oa != "[object Array]" || h.call(na, "toJSON"))) {
										na = na.toJSON(ga)
									}
								}
							}
									...
									if("{}[]:,".indexOf(ia) > -1) {
										...
										if(ia == '"') {
											...
											if(ga.slice(z, z + 4) == "true") {
												...
												if(ga.slice(z, z + 5) == "false") {
													z += 5;
													return false
												}else {
													if(ga.slice(z, z + 4) == "null") {
														z += 4;
														return null
													}
												}
	...
	(function() {
		...
		className:"FB.XFBML.Friendpile"}, {localName:"name", className:"FB.XFBML.Name"}, {localName:"page-events", className:"FB.XFBML.PageEvents"}, {localName:"privacy-selector", className:"FB.XFBML.PrivacySelector"}, {localName:"profile-pic", className:"FB.XFBML.ProfilePic"}, {localName:"recommendations", className:"FB.XFBML.Recommendations"}, {localName:"recommendations-bar", className:"FB.XFBML.RecommendationsBar"}, {localName:"rectangle", className:"FB.XFBML.Rectangle"}, {localName:"registration", 
		className:"FB.XFBML.Registration"}, {localName:"send", className:"FB.XFBML.Send"}, {localName:"share-button", className:"FB.XFBML.ShareButton"}, {localName:"social-context", className:"FB.XFBML.SocialContext"}, {localName:"subscribe", className:"FB.XFBML.Subscribe"}], _widgetPipeEnabledTagCount:0, _widgetPipeIsEnabled:function() {
