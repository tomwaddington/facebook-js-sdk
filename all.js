...
FB.subclass("XFBML.Read", "XFBML.IframeWidget", null, {getUrlBits:function() {
	...
	this._attr = {channel:this.getChannelUrl(), api_key:FB._apiKey, font:this.getAttribute("font"), colorscheme:this.getAttribute("colorscheme", "light"), href:this.getAttribute("href", window.location.href), ref:this.getAttribute("ref"), trigger:f(this.getAttribute("trigger", "")), mintime:parseInt(this.getAttribute("mintime"), 10) || 30};
